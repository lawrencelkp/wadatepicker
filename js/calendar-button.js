...
window.addEventListener('load' , function () {
  ...
  // var datePickers2 = document.querySelectorAll('#myDatepicker2');
  //
  // datePickers2.forEach(function (dp) {
  //   var inputNode   = dp.querySelector('input');
  //   var buttonNode  = dp.querySelector('button');
  //   var dialogNode  = dp.querySelector('[role=dialog]');
  //
  //   var datePickers2 = new DatePicker(inputNode, buttonNode, dialogNode);
  //   datePickers2.init();
  // });
